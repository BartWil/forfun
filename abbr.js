...
(function () {
  ...
  const A = {
    ...
    BSP:  { en: { full: "body segment parameters", d: "The mass, centre of mass position and moment of inertia of each body segment. Read from published tables, not measured on you." },
          pl: { full: "body segment parameters (parametry segmentów ciała)", d: "Masa, położenie środka masy i moment bezwładności każdego segmentu ciała. Odczytywane z opublikowanych tabel, a nie mierzone u Ciebie." } },
  IK:   { en: { full: "inverse kinematics", d: "Finding the joint angles that best fit the measured marker positions." },
          pl: { full: "inverse kinematics (kinematyka odwrotna)", d: "Wyznaczanie kątów stawowych najlepiej pasujących do zmierzonych położeń markerów." } },
  ID:   { pages: ["dynamics.html"], en: { full: "inverse dynamics", d: "Computing joint forces and moments from measured motion and external forces, working from the ground up." },
          pl: { full: "inverse dynamics (dynamika odwrotna)", d: "Obliczanie sił i momentów w stawach na podstawie zmierzonego ruchu i sił zewnętrznych, od podłoża w górę." } },
  RRA:  { en: { full: "residual reduction algorithm", d: "An OpenSim step that nudges the model until the measured forces and the measured motion stop contradicting each other." },
          pl: { full: "residual reduction algorithm (algorytm redukcji resztek)", d: "Krok w OpenSim, który koryguje model, aż zmierzone siły i zmierzony ruch przestaną sobie przeczyć." } },
  CMC:  { en: { full: "computed muscle control", d: "An OpenSim method that finds a set of muscle excitations able to reproduce a measured movement." },
          pl: { full: "computed muscle control (obliczeniowe sterowanie mięśniami)", d: "Metoda w OpenSim znajdująca zestaw pobudzeń mięśni zdolny odtworzyć zmierzony ruch." } },
  DOF:  { en: { full: "degrees of freedom", d: "The number of independent ways a model can move. A full lower-limb gait model typically has around 21." },
          pl: { full: "degrees of freedom (stopnie swobody)", d: "Liczba niezależnych sposobów, w jakie model może się poruszać. Pełny model chodu kończyny dolnej ma zwykle około 21." } },
  C3D:  { en: { full: "Coordinate 3D file format", d: "The standard binary file a gait laboratory stores marker, force plate and EMG data in." },
          pl: { full: "Coordinate 3D (format pliku)", d: "Standardowy plik binarny, w którym pracownia chodu zapisuje dane markerów, platformy i EMG." } },
