...
(function () {
  ...
  const STATIC = {
    ...
    "isb.sub": "Zanim powstały te dwie prace, każda pracownia mogła zmierzyć to samo kolano, ten sam bark, ten sam chód — i opublikować inne liczby, bo każda wybrała własne osie i własną kolejność obrotów. Zalecenia ISB ustaliły definicje. Niemal każdy wynik z rejestracji ruchu, jaki przeczytasz, opiera się na nich. <b>Najedź kursorem na podkreślony fragment, żeby zobaczyć, co dokładnie mówią te prace.</b>",
    ...
    "isb.s2.p": "To sedno sprawy. Poniżej ten sam segment dostaje <b>te same dwa obroty</b> — jeden wokół Z, drugi wokół X — wykonane w dwóch możliwych kolejnościach. Przesuń suwak i patrz, jak oba końce ruchu się rozjeżdżają. Prace mówią to wprost: <span class=\"q\" data-q=\"order\">zgięcie, a po nim odwodzenie to nie to samo, co odwodzenie, a po nim zgięcie</span>. Kiedy Karduna ze współpracownikami sprawdzili wszystkie możliwe sekwencje dla ruchu łopatki, opisali <span class=\"q\" data-q=\"karduna\">różnice sięgające 50° dla niektórych kątów</span> — biorące się wyłącznie z kolejności.",
    "isb.s2.foot": "Dlatego właśnie standard zaznacza, że <span class=\"q\" data-q=\"seqindep\">sam JCS nie zależy od sekwencji, a kąty Eulera i Cardana już tak</span>. Wybór konwencji to nie pedanteria — to różnica między dwiema pracowniami, które się zgadzają, a dwiema, które po cichu się rozmijają.",
    "isb.s3.label": "Przed standardem",
    "isb.s3.h": "Trzy konwencje, jeden krąg",
    "isb.s3.p": "Na kręgosłupie było najgorzej i część I mówi o tym wprost: <span class=\"q\" data-q=\"othercon\">opisano również inne konwencje osi</span>. Oto trzy wymienione w pracy, na tej samej kości. W samym kręgu nie zmienia się nic — zmieniają się tylko etykiety. Liczba podana jako „obrót wokół Z” oznacza trzy różne ruchy, zależnie od tego, czyją pracę trzymasz w ręku.",
    "isb.s4.label": "Przepis",
    "isb.s4.h": "Jak buduje się układ współrzędnych stawu",
    "isb.s4.a.h": "Nadaj każdej kości własne osie",
    "isb.s4.a.p": "Każdy segment dostaje układ kartezjański wyznaczony przez <span class=\"q\" data-q=\"landmarks\">punkty kostne, które da się wybadać palpacyjnie albo odnaleźć na zdjęciu rentgenowskim</span>. To ograniczenie jest zamierzone — definicja, której nie umiesz odnaleźć na żywym człowieku, jest w pracowni chodu bezużyteczna. Tam, gdzie punkt nie jest wyczuwalny, jak środek stawu biodrowego, praca podaje sposób jego oszacowania i <span class=\"q\" data-q=\"palpable\">trzyma się punktów dostępnych in vivo</span>.",
    ...
    "isb.s4.c.p": "Obrót wokół e1 to zgięcie i wyprost, wokół pływającej e2 — odwodzenie i przywodzenie albo zgięcie boczne, wokół e3 — rotacja osiowa. Do tego dochodzą trzy przesunięcia. Cały sens tego zabiegu polega na tym, że <span class=\"q\" data-q=\"communication\">wszyscy mówią wtedy o tym samym</span>.",
    "isb.s5.label": "Staw po stawie",
    "isb.s5.h": "Co dokładnie mówi standard",
    "isb.s5.p": "Wybierz staw. Animacja przechodzi kolejno przez e1, e2 i e3, żeby pokazać, która oś odpowiada za który ruch, a tabela podaje definicję w opublikowanej postaci. <span class=\"isb-badge\">I</span> oznacza pracę z 2002 roku (staw skokowy, biodrowy, kręgosłup), <span class=\"isb-badge\">II</span> — pracę z 2005 roku (bark, łokieć, nadgarstek, ręka).",
    ...
    "isb.s6.b.p": "<span class=\"q\" data-q=\"gheuler\">Staw ramienno-łopatkowy jest jedynym opartym na prawdziwej sekwencji Eulera</span> (Y–X–Y), ponieważ e1 i e3 są początkowo równoległe. Zwykłe równania osi pływającej tam nie obowiązują — stosuje się rozkład Eulera.",
    "isb.s6.c.h": "Zawsze podawaj swoją konwencję",
    "isb.s6.c.p": "Nawet dziś kąt w stawie bez podanego układu współrzędnych i kolejności obrotów nie jest odtwarzalny. Nazwanie standardu, z którego się skorzystało — wraz z wersją — kosztuje jedno zdanie w metodyce i oszczędza czytelnikowi zgadywania.",
