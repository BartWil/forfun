...
(function () {
  ...
  const STATIC = {
    ...
    "ph.s2.c2p": "<b>Siła</b>, z jaką grawitacja ciągnie tę materię w dół. To siła, więc mierzy się ją w niutonach, i bardzo ją obchodzi, gdzie jesteś. Ta sama osoba 70 kg waży około 687 N na Ziemi i około 114 N na Księżycu, bo Księżyc przyciąga słabiej.",
    ...
    "ph.s3.p2": "Oto zdanie, którego warto się trzymać. <b>Przyspieszenie to nie jest to, jak szybko jedziesz. Przyspieszenie to tempo, w jakim zmienia się Twoja prędkość.</b> Są tak różne, że można mieć ogrom jednego i zero drugiego, a warto zobaczyć wszystkie cztery kombinacje obok siebie, bo co najmniej dwie zaskakują.",
    "ph.s3.g1h": "Siedzenie na krześle",
    "ph.s3.g1p": "Prędkość zero. Przyspieszenie zero. Nic się nie dzieje, czyli przypadek łatwy.",
    "ph.s3.g2h": "Jazda autostradą",
    "ph.s3.g2p": "<b>Ogromna prędkość. Zerowe przyspieszenie.</b> Pokonujesz drogę szybko, ale Twoja prędkość się nie zmienia, więc przyspieszenia nie ma w ogóle. To ta sytuacja, którą najtrudniej przyjąć.",
    ...
    "ph.s3.p3": "Ta ostatnia ramka znaczy więcej, niż wygląda, bo w chodzie i biegu ciekawe siły to głównie te hamujące. Za każdym razem, gdy stopa ląduje, hamujesz, a hamowanie to przyspieszenie skierowane do tyłu, co zgodnie z drugą zasadą oznacza prawdziwą siłę skierowaną do tyłu. To nie metafora.",
    ...
    "ph.s4.r1": "<b>Znasz masę i przyspieszenie, szukasz siły.</b> „Ten biegacz 70 kg hamuje przy lądowaniu z 4 m/s², jaka siła przez niego przeszła?”",
    ...
    "ph.s5.p2": "Zobacz, czym to jest, skoro już wiesz to, co wiesz. Wstaw zero do drugiej zasady: jeśli <span class='sym' data-sym='Fnet'>F</span> jest zerem, to <span class='sym' data-sym='a'>a</span> musi być zerem, a zerowe przyspieszenie znaczy, że prędkość nigdy się nie zmienia. <b>Pierwsza zasada to druga zasada, gdy nic nie pcha.</b> Dlatego wydaje się przypadkiem szczególnym, a nie osobnym odkryciem.",
    ...
    "ph.s7.say": "Na głos: <b>„efekt obrotowy równa się siła razy jej odległość od osi obrotu”</b>. Jednostką jest niutonometr, N·m, czyli dosłownie dwie jednostki pomnożone przez siebie.",
    ...
    "ph.s7.p3": "W ciele ta odległość jest zwykle krótka i niewygodna. Mięsień przyczepia się blisko stawu, który porusza, więc jego odległość od osi jest mała i dlatego potrzebuje <b>dużej</b> siły, by wytworzyć umiarkowany efekt obrotowy. Tymczasem obciążenie w dłoni siedzi daleko, na końcu długiego przedramienia, z dużą odległością i odpowiednio dużym efektem obrotowym od małego ciężaru. Ta geometryczna niesprawiedliwość sprawia, że mięśnie ciągną siłami znacznie większymi niż ciężary, które podnoszą, i jest tematem stacji Maszyna mięśniowa.",
