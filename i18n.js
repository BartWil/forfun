...
(function () {
  ...
  const STATIC = {
    ...
    "lp.eng.body": "To ciało to model <b>biotensegracyjny</b>. Białe elementy to kości: rozpórki ściskane, które <b>nigdy się nie stykają</b>. Każda turkusowa linia to element napięciowy zastępujący mięsień, ścięgno i powięź, i potrafi <b>wyłącznie ciągnąć, nigdy pchać</b>, bo tkanka nie popchnie liny. Sieć napięcia jest ciągła, więc obciążenie przyłożone gdziekolwiek wędruje wszędzie. Pociągnij bark w bok, a <b>przeciwne kolano podąży za nim równie daleko</b>. Pociągnij kolano, a głowa odchyli się dalej niż Twoja własna dłoń. Długie przekątne biegnące od każdego barku do przeciwnej strony miednicy mają swoją nazwę: to <b>taśma skośna tylna</b>, od najszerszego grzbietu przez powięź piersiowo-lędźwiową do przeciwstronnego mięśnia pośladkowego wielkiego. Spróbuj teraz <em>dłoni</em>. Prawie nic innego się nie poruszy, bo ramię obraca się swobodnie w barku i <em>zwisa</em> z sieci, pozostając poza nią. To jeden z powodów, dla których problemy obręczy barkowej zachowują się zupełnie inaczej niż kręgosłupowe.",
